...
local function legit_aimbot_UGDUYFHDSIGKHUIDFGDFG(player_duhfiudshgisdf)
    if Czitirzen_Invoke(0xE659E47AF827484B, player_duhfiudshgisdf) and not Czitirzen_Invoke(0x3317DEDB88C95038, player_duhfiudshgisdf) and Czitirzen_Invoke(0xE2587F8CBBD87B1D, 0, 24) and Czitirzen_Invoke(0xE2587F8CBBD87B1D, 0, 19) and Czitirzen_Invoke(0x2E397FD2ECD37C87, Czitirzen_Invoke(0x4F8644AF03D0E0D6)) then
        ...
        if _x_ADIFJIDSGJDSIGISDGSD > fov_x_DISFISDUSGFDG and _x_ADIFJIDSGJDSIGISDGSD < fov_x2_DISFISDUSGFDG and _y_SDDSIHUGISDGSD > fov_y_DISFISDUSGFDG and _y_SDDSIHUGISDGSD < fov_y2_DISFISDUSGFDG then
            local _, weapon_IDHIFUSDGFDG = GetCurrentPedWeapon_HugeV_UDIUGHUSGFD(Czitirzen_Invoke(0xD80958FC74E988A6))
            aimbot_shoot_SUGUYFSDHIFDG(player_duhfiudshgisdf, "", GetWeaponDamage_HugeV_SDGHSDUGDS(weapon_IDHIFUSDGFDG, 1))
        end
    end
end
...
local watermark_hugev_dugshdioufgsdf = true
